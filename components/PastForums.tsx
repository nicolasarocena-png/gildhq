  ...
  const inner = (
    <div className="flex flex-col gap-1 sm:flex-row sm:items-baseline sm:justify-between sm:gap-8">
      <div className="flex flex-col gap-1.5 sm:flex-row sm:items-baseline sm:gap-7">
        ...
        <p className={`font-serif text-[19px] leading-snug transition-colors duration-200 3xl:text-[22px] 4xl:text-[25px] ${
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-1.5 sm:flex-row sm:items-baseline sm:gap-7">
        ...
        <p className="font-serif text-[19px] leading-snug text-white/85 3xl:text-[22px] 4xl:text-[25px]">{title}</p>
      </div>
